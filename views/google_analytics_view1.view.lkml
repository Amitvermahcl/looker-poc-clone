...
explore: google_analytics_view1 {
  hidden: yes
    join: google_analytics_view1__hits {
      view_label: "Google Analytics View1: Hits"
      sql: LEFT JOIN UNNEST(${google_analytics_view1.hits}) as google_analytics_view1__hits ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__custom_dimensions {
      view_label: "Google Analytics View1: Customdimensions"
      sql: LEFT JOIN UNNEST(${google_analytics_view1.custom_dimensions}) as google_analytics_view1__custom_dimensions ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__product {
      view_label: "Google Analytics View1: Hits Product"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.product}) as google_analytics_view1__hits__product ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__promotion {
      view_label: "Google Analytics View1: Hits Promotion"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.promotion}) as google_analytics_view1__hits__promotion ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__custom_metrics {
      view_label: "Google Analytics View1: Hits Custommetrics"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.custom_metrics}) as google_analytics_view1__hits__custom_metrics ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__custom_variables {
      view_label: "Google Analytics View1: Hits Customvariables"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.custom_variables}) as google_analytics_view1__hits__custom_variables ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__custom_dimensions {
      view_label: "Google Analytics View1: Hits Customdimensions"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.custom_dimensions}) as google_analytics_view1__hits__custom_dimensions ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__experiment {
      view_label: "Google Analytics View1: Hits Experiment"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.experiment}) as google_analytics_view1__hits__experiment ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__publisher_infos {
      view_label: "Google Analytics View1: Hits Publisher Infos"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits.publisher_infos}) as google_analytics_view1__hits__publisher_infos ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__product__custom_metrics {
      view_label: "Google Analytics View1: Hits Product Custommetrics"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits__product.custom_metrics}) as google_analytics_view1__hits__product__custom_metrics ;;
      relationship: one_to_many
    }
    join: google_analytics_view1__hits__product__custom_dimensions {
      view_label: "Google Analytics View1: Hits Product Customdimensions"
      sql: LEFT JOIN UNNEST(${google_analytics_view1__hits__product.custom_dimensions}) as google_analytics_view1__hits__product__custom_dimensions ;;
      relationship: one_to_many
    }
}
view: google_analytics_view1 {
  sql_table_name: `poc_data.google_analytics_view1` ;;
...
view: google_analytics_view1__hits {
  ...
  dimension: google_analytics_view1__hits {
    type: string
    hidden: yes
    sql: google_analytics_view1__hits ;;
  }
  ...
  dimension: uses_transient_token {
    type: string
    sql: uses_transient_token ;;
  }
}

view: google_analytics_view1__custom_dimensions {

  dimension: google_analytics_view1__custom_dimensions {
    type: string
    hidden: yes
    sql: google_analytics_view1__custom_dimensions ;;
  }
  dimension: index {
    type: number
    sql: index ;;
...
view: google_analytics_view1__hits__product {
...
view: google_analytics_view1__hits__promotion {
...
view: google_analytics_view1__hits__custom_metrics {
...
view: google_analytics_view1__hits__custom_variables {
...
view: google_analytics_view1__hits__custom_dimensions {
...
view: google_analytics_view1__hits__experiment {
...
view: google_analytics_view1__hits__publisher_infos {
...
view: google_analytics_view1__hits__product__custom_metrics {
...
view: google_analytics_view1__hits__product__custom_dimensions {
